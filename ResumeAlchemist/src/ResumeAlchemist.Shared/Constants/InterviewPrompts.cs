...
## 问题类别要求（共 6 个问题，严格遵守）
1. 技术深度：2 个问题（针对简历中提到的技术栈和工具的深入问题）
2. 项目经验：2 个问题（关于具体项目的细节、挑战和解决方案）
3. 行为面试：1 个问题（考察软技能、团队协作、冲突处理等）
4. 职业规划：1 个问题（关于职业目标、发展方向、离职原因等）

## 输出要求
- 必须严格输出 6 个问题，不多不少
- 问题要基于简历内容，有针对性，避免通用问题
- 回答建议要具体、可操作
